...
- [x] 07-09-PLAN.md — Fix AudioChannel filter for mono/stereo input (Gap 1)
- [x] 07-10-PLAN.md — Fix MetadataWrite to inject global metadata (Gap 2)
- [x] 07-11-PLAN.md — Fix FrameDrop frame count parsing N/A (Gap 3)
- [x] 07-12-PLAN.md — GPU-accelerated video filters (Crop) for NVENC (Gap 4)
