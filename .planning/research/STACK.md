...
const cmd = Command.create('ffmpeg', ['-i', inputPath, '-vf', filterGraph, '-y', outputPath]);
...
_Stack research for: Tauri 2.x + Vue 3 + FFmpeg desktop video batch processing tool_
