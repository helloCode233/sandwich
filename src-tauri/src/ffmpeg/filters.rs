...
///
/// hue_cuda and colorspace_cuda do NOT exist in FFmpeg with color-space params.
/// This op is CPU-only; GPU acceleration comes from hwaccel decode + NVENC encode.
...
///
/// eq_cuda and colorspace_cuda (with color-space params) do NOT exist in FFmpeg.
/// This op is CPU-only; GPU acceleration comes from hwaccel decode + NVENC encode.
...
pub fn build_filter_args(
    ...
    match op.op_type {
        ...
        // Phase 6: Color processing (D-01, D-02) — CPU-only
...
pub fn build_filter_args_separated(
    ...
    match op.op_type {
        ...
        // Phase 6: Color processing — CPU-only
