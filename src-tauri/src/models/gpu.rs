...
impl GpuEncoder {
    ...
    /// Currently only NVENC supports GPU-side filters (scale_cuda, bilateral_cuda,
    /// transpose_cuda — crop_cuda, fps_cuda, hue_cuda, eq_cuda, gblur_cuda,
    /// unsharp_cuda, hflip_cuda do NOT exist in FFmpeg).
